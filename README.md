# mcpelauncher-motion-blur

Motion blur for [mcpelauncher](https://minecraft-linux.github.io).
...
Download the mod from [releases](https://github.com/CrackedMatter/mcpelauncher-motion-blur/releases/latest) and move the file into the `mods` directory.
